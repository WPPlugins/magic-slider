...
class Magic_Slider {
	...
	public static function plugin_row_meta( $links, $file ) {
		if ( $file == plugin_basename( __FILE__ ) ) {
			$row_meta = array(
				'support' => '<a href="http://web-profile.com.ua/wordpress/plugins/magic-slider/" target="_blank"><span class="dashicons dashicons-editor-help"></span> ' . __( 'Magic Slider', 'magic-slider' ) . '</a>',
				'donate' => '<a href="http://web-profile.com.ua/donate/" target="_blank"><span class="dashicons dashicons-heart"></span> ' . __( 'Donate', 'magic-slider' ) . '</a>'
			);
